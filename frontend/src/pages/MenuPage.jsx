...
import { FaShoppingCart, FaHistory, FaWallet, FaUtensils } from 'react-icons/fa';
...
import PersonalizedMealGenerator from './PersonalizedMealGenerator';
      ...
      <div className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 flex flex-col items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-10">
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            ...
            <motion.button
              className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 px-6 rounded-xl shadow-lg hover:scale-105 transition-all"
              onClick={() => navigate("/personalized-meal")}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <FaUtensils className="inline mr-2" /> Personalized Meal
            </motion.button>
          </div>
        </div>
